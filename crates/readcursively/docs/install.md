# Installing readcursively

Prebuilt binaries are published on the
[GitHub Releases](https://github.com/riceharvest/agents-first-toolkit/releases) page
...
```sh
READCURSIVELY_VERSION=v0.1.0 sh install.sh        # macOS / Linux
$env:READCURSIVELY_VERSION = "v0.1.0"; irm .../install.ps1 | iex   # Windows
```

## Self-update

An installed binary updates itself in place (checksum-verified):
...
1. Download `readcursively-<version>-<target>.tar.gz` (or `.zip` on Windows)
...
```sh
git clone https://github.com/riceharvest/agents-first-toolkit
cd readcursively
cargo install --path .
```
